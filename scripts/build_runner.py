...
class BuildRunner:
    def __init__(self, root_dir: Path, build_dir: Path, project_name: str, version_var: str = "PROJECT_VERSION") -> None:
        ...
        self.version_manager = VersionManager(CMAKE_FILE, version_var=version_var)
